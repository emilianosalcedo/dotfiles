...
"let s:N1   = [ '#fcfcfc' , '#3daee9' , 'White'  , 'Blue' ]
"let s:N2   = [ '#fcfcfc' , '#3daee9' , 'White' , 'Blue' ]
"let s:N3   = [ '#3daee9' , '#313639' , 'Blue'  , 'Black' ]
let s:N1   = [ '#fcfcfc' , '#fdbc4b' , 7  , 74 ]
let s:N2   = [ '#31363b' , '#fdbc4b' , 7  , 74 ]
let s:N3   = [ '#fcfcfc' , '#fdbc4b' , 74  , 237 ]
let g:airline#themes#breeze#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#breeze#palette.accents = {
      \ 'red': [ '#da4453' , '' , 167 , ''  ]
      \ }

let pal = g:airline#themes#breeze#palette
